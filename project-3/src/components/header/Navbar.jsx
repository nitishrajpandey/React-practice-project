  ...
  return (
    <>
      <nav className="fixed top-0 z-50 bg-white w-full h-[10vh] flex justify-between items-center px-5 md:px-10 border-b border-b-gray shadow-md">
        ...
        <div className="">
          <button className=" mr-4 px-2 py-1 sm:px-4 sm:py-2 shadow-md rounded-md ">
            LOG IN
          </button>
          <button className="px-2 py-1 sm:px-4 sm:py-2 bg-[#42454A] shadow-md text-white  rounded-md ">
            SIGN UP
          </button>
        </div>
      </nav>
