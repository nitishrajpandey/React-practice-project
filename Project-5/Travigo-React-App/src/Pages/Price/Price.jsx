  ...
  return (
    <div className="w-full flex flex-col pb-20 mb-20 justify-center items-center relative top-40">
      <div className="flex gap-10 flex-wrap justify-center">
        {memberShipPlanDetails.plan.map((item, index) => (
          <div
            key={index}
            className="border border-slate-100 rounded-2xl shadow-lg shadow-slate-200 p-5 hover:scale-105 duration-300 ease-in-out lg:max-w-[650px]"
          >
